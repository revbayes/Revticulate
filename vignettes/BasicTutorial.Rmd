...
```{r}
doRev('morpho <- readDiscreteCharacterData("../data/Cinctans.nex")
num_taxa <- morpho.size()
num_branches <- 2 * num_taxa - 2
taxa <- morpho.names()
br_len_lambda ~ dnExp(0.2)
...
Using RevKnitR for long computations is not advisable. This is because it relies on System2 to run the underlying RevBayes executeable. To run your actual MCMC, it's probably best to save your code to a script and run it in the terminal.
